...
struct DEV_DimmableLED : Service::LightBulb {       // Dimmable LED
  ...
  DEV_DimmableLED(int pin) : Service::LightBulb(){       // constructor() method
    ...
    level=new Characteristic::Brightness(10);       // NEW! Instantiate the Brightness Characteristic with an initial value of 10% (same as we did in Example 4)
  ...
  boolean update(){                              // update() method
    ...
    dac.setDACOutVoltage(map(long(level), 0, 100, 0, 10000),0);
